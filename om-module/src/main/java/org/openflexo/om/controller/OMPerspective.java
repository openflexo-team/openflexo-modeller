...
/**
 * A perspective allowing to show and edit resources with tabular views
 * 
 * @author sylvain
 * 
 */
public class OMPerspective extends GenericPerspective {

	static final Logger logger = Logger.getLogger(OMPerspective.class.getPackage().getName());

	/**
	 * @param controller
	 * @param name
	 */
	public OMPerspective(FlexoController controller) {
		super(controller);
	}

	@Override
	public String getName() {
		return "tabular_perspective";
	}
	...
	public ModuleView<?> createModuleViewForMasterObject(FlexoObject object) {
		if (object instanceof FlexoConcept) {
			return new StandardFlexoConceptView((FlexoConcept) object, getController(), this);
		}
